var stephenResume = function() {
  ...
  resume['dayta'] = new DetailedInformation('DAYTA Marketing', 'DAYTA Marketing is a full-service social media management company.  My job at DAYTA is to optimize current processes and procedures with existing technology, identify areas where we can create custom software to help scale our business, and lead a team in the development of that custom software.');
